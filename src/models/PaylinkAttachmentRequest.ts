...
export function PaylinkAttachmentRequestToJSON(json: any): PaylinkAttachmentRequest {
    return PaylinkAttachmentRequestToJSONTyped(json, false);
}

export function PaylinkAttachmentRequestToJSONTyped(value?: PaylinkAttachmentRequest | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
