 ...
 * 
 * @export
 * @interface RequestChallenged
 */
export interface RequestChallenged {
    /**
     * The url of the Access Control Server (ACS) to forward the user to.
     * 
     * @type {string}
     * @memberof RequestChallenged
     */
    acsUrl?: string;
    /**
...
export function RequestChallengedFromJSON(json: any): RequestChallenged {
    return RequestChallengedFromJSONTyped(json, false);
}
...
export function RequestChallengedToJSON(json: any): RequestChallenged {
    return RequestChallengedToJSONTyped(json, false);
}

export function RequestChallengedToJSONTyped(value?: RequestChallenged | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
