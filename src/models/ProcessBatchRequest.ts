...
import {
    ...
    BatchTransactionFromJSONTyped,
    BatchTransactionToJSON,
    BatchTransactionToJSONTyped,
...
export function ProcessBatchRequestFromJSON(json: any): ProcessBatchRequest {
    return ProcessBatchRequestFromJSONTyped(json, false);
}
...
export function ProcessBatchRequestToJSON(json: any): ProcessBatchRequest {
    return ProcessBatchRequestToJSONTyped(json, false);
}

export function ProcessBatchRequestToJSONTyped(value?: ProcessBatchRequest | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
