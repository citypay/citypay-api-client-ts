...
import {
    ...
    PaylinkCartItemModelToJSONTyped,
...
export function PaylinkCartToJSON(json: any): PaylinkCart {
    return PaylinkCartToJSONTyped(json, false);
}

export function PaylinkCartToJSONTyped(value?: PaylinkCart | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
