 ...
 * 
 * @export
 * @interface CheckBatchStatusResponse
 */
export interface CheckBatchStatusResponse {
    /**
     * 
     * @type {Array<Batch>}
     * @memberof CheckBatchStatusResponse
     */
    batches?: Array<Batch>;
}
...
export function CheckBatchStatusResponseFromJSON(json: any): CheckBatchStatusResponse {
    return CheckBatchStatusResponseFromJSONTyped(json, false);
}
...
export function CheckBatchStatusResponseToJSON(json: any): CheckBatchStatusResponse {
    return CheckBatchStatusResponseToJSONTyped(json, false);
}

export function CheckBatchStatusResponseToJSONTyped(value?: CheckBatchStatusResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
