...
export function DirectTokenAuthRequestToJSON(json: any): DirectTokenAuthRequest {
    return DirectTokenAuthRequestToJSONTyped(json, false);
}

export function DirectTokenAuthRequestToJSONTyped(value?: DirectTokenAuthRequest | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
