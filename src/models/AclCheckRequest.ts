...
export function AclCheckRequestFromJSON(json: any): AclCheckRequest {
    return AclCheckRequestFromJSONTyped(json, false);
}
...
export function AclCheckRequestToJSON(json: any): AclCheckRequest {
    return AclCheckRequestToJSONTyped(json, false);
}

export function AclCheckRequestToJSONTyped(value?: AclCheckRequest | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
