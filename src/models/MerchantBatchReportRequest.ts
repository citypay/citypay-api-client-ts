...
export function MerchantBatchReportRequestToJSON(json: any): MerchantBatchReportRequest {
    return MerchantBatchReportRequestToJSONTyped(json, false);
}

export function MerchantBatchReportRequestToJSONTyped(value?: MerchantBatchReportRequest | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
