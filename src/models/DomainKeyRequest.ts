 ...
 * 
 * @export
 * @interface DomainKeyRequest
 */
export interface DomainKeyRequest {
    /**
     * 
     * @type {Array<string>}
     * @memberof DomainKeyRequest
     */
    domain: Array<string>;
    /**
...
export function DomainKeyRequestFromJSON(json: any): DomainKeyRequest {
    return DomainKeyRequestFromJSONTyped(json, false);
}
...
export function DomainKeyRequestToJSON(json: any): DomainKeyRequest {
    return DomainKeyRequestToJSONTyped(json, false);
}

export function DomainKeyRequestToJSONTyped(value?: DomainKeyRequest | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
