...
export function RegisterCardFromJSON(json: any): RegisterCard {
    return RegisterCardFromJSONTyped(json, false);
}
...
export function RegisterCardToJSON(json: any): RegisterCard {
    return RegisterCardToJSONTyped(json, false);
}

export function RegisterCardToJSONTyped(value?: RegisterCard | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
