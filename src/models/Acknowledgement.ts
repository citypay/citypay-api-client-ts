...
export function AcknowledgementToJSON(json: any): Acknowledgement {
    return AcknowledgementToJSONTyped(json, false);
}

export function AcknowledgementToJSONTyped(value?: Acknowledgement | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
