...
export function BatchTransactionReportResponseToJSON(json: any): BatchTransactionReportResponse {
    return BatchTransactionReportResponseToJSONTyped(json, false);
}

export function BatchTransactionReportResponseToJSONTyped(value?: BatchTransactionReportResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
