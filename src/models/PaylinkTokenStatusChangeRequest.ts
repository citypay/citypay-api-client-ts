 ...
 * 
 * @export
 * @interface PaylinkTokenStatusChangeRequest
 */
export interface PaylinkTokenStatusChangeRequest {
    /**
     * identifies the date and time to lookup changes after.
     * @type {Date}
     * @memberof PaylinkTokenStatusChangeRequest
     */
    after: Date;
    /**
...
export function PaylinkTokenStatusChangeRequestFromJSON(json: any): PaylinkTokenStatusChangeRequest {
    return PaylinkTokenStatusChangeRequestFromJSONTyped(json, false);
}
...
export function PaylinkTokenStatusChangeRequestToJSON(json: any): PaylinkTokenStatusChangeRequest {
    return PaylinkTokenStatusChangeRequestToJSONTyped(json, false);
}

export function PaylinkTokenStatusChangeRequestToJSONTyped(value?: PaylinkTokenStatusChangeRequest | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
