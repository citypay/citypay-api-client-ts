...
export function PaylinkTokenStatusToJSON(json: any): PaylinkTokenStatus {
    return PaylinkTokenStatusToJSONTyped(json, false);
}

export function PaylinkTokenStatusToJSONTyped(value?: PaylinkTokenStatus | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
