...
export function PaylinkPartPaymentsToJSON(json: any): PaylinkPartPayments {
    return PaylinkPartPaymentsToJSONTyped(json, false);
}

export function PaylinkPartPaymentsToJSONTyped(value?: PaylinkPartPayments | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
