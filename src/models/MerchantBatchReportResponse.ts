 ...
 * 
 * @export
 * @interface MerchantBatchReportResponse
 */
export interface MerchantBatchReportResponse {
    /**
     * 
     * @type {Array<MerchantBatchResponse>}
     * @memberof MerchantBatchReportResponse
     */
...
export function MerchantBatchReportResponseFromJSON(json: any): MerchantBatchReportResponse {
    return MerchantBatchReportResponseFromJSONTyped(json, false);
}
...
export function MerchantBatchReportResponseToJSON(json: any): MerchantBatchReportResponse {
    return MerchantBatchReportResponseToJSONTyped(json, false);
}

export function MerchantBatchReportResponseToJSONTyped(value?: MerchantBatchReportResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
