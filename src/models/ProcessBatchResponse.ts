...
export function ProcessBatchResponseFromJSON(json: any): ProcessBatchResponse {
    return ProcessBatchResponseFromJSONTyped(json, false);
}
...
export function ProcessBatchResponseToJSON(json: any): ProcessBatchResponse {
    return ProcessBatchResponseToJSONTyped(json, false);
}

export function ProcessBatchResponseToJSONTyped(value?: ProcessBatchResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
