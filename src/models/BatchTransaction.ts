...
export function BatchTransactionFromJSON(json: any): BatchTransaction {
    return BatchTransactionFromJSONTyped(json, false);
}
...
export function BatchTransactionToJSON(json: any): BatchTransaction {
    return BatchTransactionToJSONTyped(json, false);
}

export function BatchTransactionToJSONTyped(value?: BatchTransaction | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
