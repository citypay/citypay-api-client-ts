...
import {
    ...
    MerchantBatchResponseToJSONTyped,
...
export function RemittedClientDataToJSON(json: any): RemittedClientData {
    return RemittedClientDataToJSONTyped(json, false);
}

export function RemittedClientDataToJSONTyped(value?: RemittedClientData | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
