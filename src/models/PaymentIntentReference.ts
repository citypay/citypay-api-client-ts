...
export function PaymentIntentReferenceFromJSON(json: any): PaymentIntentReference {
    return PaymentIntentReferenceFromJSONTyped(json, false);
}
...
export function PaymentIntentReferenceToJSON(json: any): PaymentIntentReference {
    return PaymentIntentReferenceToJSONTyped(json, false);
}

export function PaymentIntentReferenceToJSONTyped(value?: PaymentIntentReference | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
