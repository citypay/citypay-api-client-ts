 ...
 * 
 * @export
 * @interface PaylinkEmailNotificationPath
 */
export interface PaylinkEmailNotificationPath {
    /**
     * 
     * @type {Array<string>}
     * @memberof PaylinkEmailNotificationPath
     */
    to: Array<string>;
    /**
     * 
...
export function PaylinkEmailNotificationPathFromJSON(json: any): PaylinkEmailNotificationPath {
    return PaylinkEmailNotificationPathFromJSONTyped(json, false);
}
...
export function PaylinkEmailNotificationPathToJSON(json: any): PaylinkEmailNotificationPath {
    return PaylinkEmailNotificationPathToJSONTyped(json, false);
}

export function PaylinkEmailNotificationPathToJSONTyped(value?: PaylinkEmailNotificationPath | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
