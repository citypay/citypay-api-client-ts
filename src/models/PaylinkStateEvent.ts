 ...
 * 
 * @export
 * @interface PaylinkStateEvent
 */
export interface PaylinkStateEvent {
    /**
     * the date and time of the event.
     * @type {Date}
     * @memberof PaylinkStateEvent
     */
    datetime?: Date;
    /**
...
export function PaylinkStateEventFromJSON(json: any): PaylinkStateEvent {
    return PaylinkStateEventFromJSONTyped(json, false);
}
...
export function PaylinkStateEventToJSON(json: any): PaylinkStateEvent {
    return PaylinkStateEventToJSONTyped(json, false);
}

export function PaylinkStateEventToJSONTyped(value?: PaylinkStateEvent | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
