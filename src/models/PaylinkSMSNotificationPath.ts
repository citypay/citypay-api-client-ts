 ...
 * 
 * @export
 * @interface PaylinkSMSNotificationPath
 */
export interface PaylinkSMSNotificationPath {
    /**
     * The phone number in [E.164](https://en.wikipedia.org/wiki/E.164) format to send the message to.
     * @type {string}
     * @memberof PaylinkSMSNotificationPath
     */
    to: string;
    /**
...
export function PaylinkSMSNotificationPathFromJSON(json: any): PaylinkSMSNotificationPath {
    return PaylinkSMSNotificationPathFromJSONTyped(json, false);
}
...
export function PaylinkSMSNotificationPathToJSON(json: any): PaylinkSMSNotificationPath {
    return PaylinkSMSNotificationPathToJSONTyped(json, false);
}

export function PaylinkSMSNotificationPathToJSONTyped(value?: PaylinkSMSNotificationPath | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
