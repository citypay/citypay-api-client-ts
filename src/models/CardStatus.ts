...
export function CardStatusToJSON(json: any): CardStatus {
    return CardStatusToJSONTyped(json, false);
}

export function CardStatusToJSONTyped(value?: CardStatus | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
