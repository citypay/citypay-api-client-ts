...
export function BinLookupFromJSON(json: any): BinLookup {
    return BinLookupFromJSONTyped(json, false);
}
...
export function BinLookupToJSON(json: any): BinLookup {
    return BinLookupToJSONTyped(json, false);
}

export function BinLookupToJSONTyped(value?: BinLookup | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
