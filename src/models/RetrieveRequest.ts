...
export function RetrieveRequestFromJSON(json: any): RetrieveRequest {
    return RetrieveRequestFromJSONTyped(json, false);
}
...
export function RetrieveRequestToJSON(json: any): RetrieveRequest {
    return RetrieveRequestToJSONTyped(json, false);
}

export function RetrieveRequestToJSONTyped(value?: RetrieveRequest | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
