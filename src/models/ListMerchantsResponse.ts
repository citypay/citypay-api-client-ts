...
export function ListMerchantsResponseFromJSON(json: any): ListMerchantsResponse {
    return ListMerchantsResponseFromJSONTyped(json, false);
}
...
export function ListMerchantsResponseToJSON(json: any): ListMerchantsResponse {
    return ListMerchantsResponseToJSONTyped(json, false);
}

export function ListMerchantsResponseToJSONTyped(value?: ListMerchantsResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
