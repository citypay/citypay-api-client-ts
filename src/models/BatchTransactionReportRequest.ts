 ...
 * 
 * @export
 * @interface BatchTransactionReportRequest
 */
export interface BatchTransactionReportRequest {
    /**
     ...
     * @type {number}
     * @memberof BatchTransactionReportRequest
     */
    maxResults?: number;
    /**
...
export function BatchTransactionReportRequestFromJSON(json: any): BatchTransactionReportRequest {
    return BatchTransactionReportRequestFromJSONTyped(json, false);
}
...
export function BatchTransactionReportRequestToJSON(json: any): BatchTransactionReportRequest {
    return BatchTransactionReportRequestToJSONTyped(json, false);
}

export function BatchTransactionReportRequestToJSONTyped(value?: BatchTransactionReportRequest | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
