...
export function AirlineAdviceToJSON(json: any): AirlineAdvice {
    return AirlineAdviceToJSONTyped(json, false);
}

export function AirlineAdviceToJSONTyped(value?: AirlineAdvice | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
