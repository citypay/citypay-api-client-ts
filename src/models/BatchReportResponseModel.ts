...
import {
    ...
    BatchTransactionResultModelToJSONTyped,
...
export function BatchReportResponseModelToJSON(json: any): BatchReportResponseModel {
    return BatchReportResponseModelToJSONTyped(json, false);
}

export function BatchReportResponseModelToJSONTyped(value?: BatchReportResponseModel | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
