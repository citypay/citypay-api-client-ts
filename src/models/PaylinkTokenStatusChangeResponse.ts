...
import {
    ...
    PaylinkTokenStatusFromJSONTyped,
    PaylinkTokenStatusToJSON,
    PaylinkTokenStatusToJSONTyped,
} from './PaylinkTokenStatus';

/**
 * 
 * @export
 * @interface PaylinkTokenStatusChangeResponse
 */
export interface PaylinkTokenStatusChangeResponse {
    /**
     * 
     * @type {Array<PaylinkTokenStatus>}
     * @memberof PaylinkTokenStatusChangeResponse
     */
...
export function PaylinkTokenStatusChangeResponseFromJSON(json: any): PaylinkTokenStatusChangeResponse {
    return PaylinkTokenStatusChangeResponseFromJSONTyped(json, false);
}
...
export function PaylinkTokenStatusChangeResponseToJSON(json: any): PaylinkTokenStatusChangeResponse {
    return PaylinkTokenStatusChangeResponseToJSONTyped(json, false);
}

export function PaylinkTokenStatusChangeResponseToJSONTyped(value?: PaylinkTokenStatusChangeResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
