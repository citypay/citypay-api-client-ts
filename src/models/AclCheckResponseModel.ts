 ...
 * 
 * @export
 * @interface AclCheckResponseModel
 */
export interface AclCheckResponseModel {
    /**
     * The name or value of the acl which was found to match the ip address.
     * @type {string}
     * @memberof AclCheckResponseModel
     */
    acl?: string;
    /**
...
export function AclCheckResponseModelFromJSON(json: any): AclCheckResponseModel {
    return AclCheckResponseModelFromJSONTyped(json, false);
}
...
export function AclCheckResponseModelToJSON(json: any): AclCheckResponseModel {
    return AclCheckResponseModelToJSONTyped(json, false);
}

export function AclCheckResponseModelToJSONTyped(value?: AclCheckResponseModel | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
