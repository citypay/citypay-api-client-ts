...
export function PaylinkCardHolderToJSON(json: any): PaylinkCardHolder {
    return PaylinkCardHolderToJSONTyped(json, false);
}

export function PaylinkCardHolderToJSONTyped(value?: PaylinkCardHolder | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
