...
export function BatchTransactionResultModelToJSON(json: any): BatchTransactionResultModel {
    return BatchTransactionResultModelToJSONTyped(json, false);
}

export function BatchTransactionResultModelToJSONTyped(value?: BatchTransactionResultModel | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
