 ...
 * 
 * @export
 * @interface DomainKeyCheckRequest
 */
export interface DomainKeyCheckRequest {
    /**
     * The domain key to check.
     * 
     * @type {string}
     * @memberof DomainKeyCheckRequest
     */
    domainKey: string;
}
...
export function DomainKeyCheckRequestFromJSON(json: any): DomainKeyCheckRequest {
    return DomainKeyCheckRequestFromJSONTyped(json, false);
}
...
export function DomainKeyCheckRequestToJSON(json: any): DomainKeyCheckRequest {
    return DomainKeyCheckRequestToJSONTyped(json, false);
}

export function DomainKeyCheckRequestToJSONTyped(value?: DomainKeyCheckRequest | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
