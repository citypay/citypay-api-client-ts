...
export function CardHolderAccountToJSON(json: any): CardHolderAccount {
    return CardHolderAccountToJSONTyped(json, false);
}

export function CardHolderAccountToJSONTyped(value?: CardHolderAccount | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
