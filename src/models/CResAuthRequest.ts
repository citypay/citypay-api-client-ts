 ...
 * 
 * @export
 * @interface CResAuthRequest
 */
export interface CResAuthRequest {
    /**
...
export function CResAuthRequestFromJSON(json: any): CResAuthRequest {
    return CResAuthRequestFromJSONTyped(json, false);
}
...
export function CResAuthRequestToJSON(json: any): CResAuthRequest {
    return CResAuthRequestToJSONTyped(json, false);
}

export function CResAuthRequestToJSONTyped(value?: CResAuthRequest | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
