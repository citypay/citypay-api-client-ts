...
export interface PaylinkTokenRequestModel {
    ...
    merchantid: number;
    /**
     * To be able to use credential on file (COF) services. A cardholder account may be created once the payment has
     ...
     * resubmission or no-show style agreements.
     * 
     * Specifies an alpha-numeric account number that the Paylink service uses when creating a Cardholder Account.
     * The value should be no longer than 20 characters in length.
     * 
     * @type {string}
     * @memberof PaylinkTokenRequestModel
     */
...
export function PaylinkTokenRequestModelToJSON(json: any): PaylinkTokenRequestModel {
    return PaylinkTokenRequestModelToJSONTyped(json, false);
}

export function PaylinkTokenRequestModelToJSONTyped(value?: PaylinkTokenRequestModel | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
