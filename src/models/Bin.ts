...
export function BinToJSON(json: any): Bin {
    return BinToJSONTyped(json, false);
}

export function BinToJSONTyped(value?: Bin | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
