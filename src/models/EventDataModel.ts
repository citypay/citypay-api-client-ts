...
export function EventDataModelToJSON(json: any): EventDataModel {
    return EventDataModelToJSONTyped(json, false);
}

export function EventDataModelToJSONTyped(value?: EventDataModel | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
