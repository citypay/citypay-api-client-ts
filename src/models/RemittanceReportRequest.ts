...
export function RemittanceReportRequestToJSON(json: any): RemittanceReportRequest {
    return RemittanceReportRequestToJSONTyped(json, false);
}

export function RemittanceReportRequestToJSONTyped(value?: RemittanceReportRequest | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
