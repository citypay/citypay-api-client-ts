 ...
 * 
 * @export
 * @interface PaylinkErrorCode
 */
export interface PaylinkErrorCode {
    /**
     * An error code identifying the error.
     * @type {string}
     * @memberof PaylinkErrorCode
     */
    code: string;
    /**
...
export function PaylinkErrorCodeFromJSON(json: any): PaylinkErrorCode {
    return PaylinkErrorCodeFromJSONTyped(json, false);
}
...
export function PaylinkErrorCodeToJSON(json: any): PaylinkErrorCode {
    return PaylinkErrorCodeToJSONTyped(json, false);
}

export function PaylinkErrorCodeToJSONTyped(value?: PaylinkErrorCode | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
