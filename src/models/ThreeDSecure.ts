...
export function ThreeDSecureToJSON(json: any): ThreeDSecure {
    return ThreeDSecureToJSONTyped(json, false);
}

export function ThreeDSecureToJSONTyped(value?: ThreeDSecure | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
