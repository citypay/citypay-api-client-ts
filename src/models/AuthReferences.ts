...
export function AuthReferencesFromJSON(json: any): AuthReferences {
    return AuthReferencesFromJSONTyped(json, false);
}
...
export function AuthReferencesToJSON(json: any): AuthReferences {
    return AuthReferencesToJSONTyped(json, false);
}

export function AuthReferencesToJSONTyped(value?: AuthReferences | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
