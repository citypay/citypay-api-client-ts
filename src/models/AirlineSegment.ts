...
export function AirlineSegmentToJSON(json: any): AirlineSegment {
    return AirlineSegmentToJSONTyped(json, false);
}

export function AirlineSegmentToJSONTyped(value?: AirlineSegment | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
