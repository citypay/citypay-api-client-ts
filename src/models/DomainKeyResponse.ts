...
export function DomainKeyResponseToJSON(json: any): DomainKeyResponse {
    return DomainKeyResponseToJSONTyped(json, false);
}

export function DomainKeyResponseToJSONTyped(value?: DomainKeyResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
