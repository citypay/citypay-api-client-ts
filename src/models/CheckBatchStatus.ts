 ...
 * 
 * @export
 * @interface CheckBatchStatus
 */
export interface CheckBatchStatus {
    /**
     * 
     * @type {Array<number>}
     * @memberof CheckBatchStatus
     */
...
export function CheckBatchStatusFromJSON(json: any): CheckBatchStatus {
    return CheckBatchStatusFromJSONTyped(json, false);
}
...
export function CheckBatchStatusToJSON(json: any): CheckBatchStatus {
    return CheckBatchStatusToJSONTyped(json, false);
}

export function CheckBatchStatusToJSONTyped(value?: CheckBatchStatus | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
