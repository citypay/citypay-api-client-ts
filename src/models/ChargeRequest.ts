...
export function ChargeRequestToJSON(json: any): ChargeRequest {
    return ChargeRequestToJSONTyped(json, false);
}

export function ChargeRequestToJSONTyped(value?: ChargeRequest | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
