...
export function PaylinkCartItemModelToJSON(json: any): PaylinkCartItemModel {
    return PaylinkCartItemModelToJSONTyped(json, false);
}

export function PaylinkCartItemModelToJSONTyped(value?: PaylinkCartItemModel | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
