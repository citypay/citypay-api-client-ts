 ...
 * 
 * @export
 * @interface PaylinkAdjustmentRequest
 */
export interface PaylinkAdjustmentRequest {
    /**
     * An amount to adjust to.
     * @type {number}
     * @memberof PaylinkAdjustmentRequest
     */
    amount?: number;
    /**
...
export function PaylinkAdjustmentRequestFromJSON(json: any): PaylinkAdjustmentRequest {
    return PaylinkAdjustmentRequestFromJSONTyped(json, false);
}
...
export function PaylinkAdjustmentRequestToJSON(json: any): PaylinkAdjustmentRequest {
    return PaylinkAdjustmentRequestToJSONTyped(json, false);
}

export function PaylinkAdjustmentRequestToJSONTyped(value?: PaylinkAdjustmentRequest | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
