...
import {
    BatchReportRequestFromJSON,
    BatchReportRequestToJSON,
    BatchReportResponseModelFromJSON,
    BatchReportResponseModelToJSON,
    CheckBatchStatusFromJSON,
    CheckBatchStatusToJSON,
    CheckBatchStatusResponseFromJSON,
    CheckBatchStatusResponseToJSON,
    ProcessBatchRequestFromJSON,
    ProcessBatchRequestToJSON,
    ProcessBatchResponseFromJSON,
 ...
 * 
 */
export class BatchProcessingApi extends runtime.BaseAPI {
