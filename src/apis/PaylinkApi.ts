...
export interface PaylinkApiPaylinkTokenCloseRequest {
    token: string;
}
...
export interface PaylinkApiTokenAttachmentStatus {
    token: string;
    attachment: string;
}
...
export class PaylinkApi extends runtime.BaseAPI {
     ...
     * Close Paylink Token
     */
    async paylinkTokenCloseRequestRaw(requestParameters: PaylinkApiPaylinkTokenCloseRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Acknowledgement>> {
        if (requestParameters.token === null || requestParameters.token === undefined) {
            throw new runtime.RequiredError('token','Required parameter requestParameters.token was null or undefined when calling paylinkTokenCloseRequest.');
        }
     ...
     * Close Paylink Token
     */
    async paylinkTokenCloseRequest(requestParameters: PaylinkApiPaylinkTokenCloseRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Acknowledgement> {
        const response = await this.paylinkTokenCloseRequestRaw(requestParameters, initOverrides);
     ...
     */
    async tokenAttachmentStatusRaw(requestParameters: PaylinkApiTokenAttachmentStatus, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Acknowledgement>> {
        if (requestParameters.token === null || requestParameters.token === undefined) {
            throw new runtime.RequiredError('token','Required parameter requestParameters.token was null or undefined when calling tokenAttachmentStatus.');
        }

        if (requestParameters.attachment === null || requestParameters.attachment === undefined) {
            throw new runtime.RequiredError('attachment','Required parameter requestParameters.attachment was null or undefined when calling tokenAttachmentStatus.');
        }
        ...
        const response = await this.request({
            path: `/paylink/{token}/attachment-status/{attachment}`.replace(`{${"token"}}`, encodeURIComponent(String(requestParameters.token))).replace(`{${"attachment"}}`, encodeURIComponent(String(requestParameters.attachment))),
            method: 'GET',
            headers: headerParameters,
            query: queryParameters,
        }, initOverrides);
     ...
     * Checks an attachment status
     */
    async tokenAttachmentStatus(requestParameters: PaylinkApiTokenAttachmentStatus, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Acknowledgement> {
        const response = await this.tokenAttachmentStatusRaw(requestParameters, initOverrides);
        return await response.value();
    }
